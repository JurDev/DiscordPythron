...
class DiscordDisco(commands.Cog):
    ...
    async def play(self, ctx, url: str):
        ...
        try:
            ...
            await ctx.channel.send('Muziek speelt')
            return
        ...
        try:
            Queue_folder = './Queue'
            if Queue_infile is True:
                print('oude Queue Folder verwijderen')
                shutil.rmtree(Queue_folder)
        except:
            print('Queue folder non-existent')

        await ctx.channel.send('Nummer wordt zo afgespeeld')
